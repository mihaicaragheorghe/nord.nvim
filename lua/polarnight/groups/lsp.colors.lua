...
function M.get(c, opts)
    return {
        ...
        LspDiagnosticsDefaultWarning         = { fg = c.nord12 },
        ...
        LspDiagnosticsUnderlineWarning       = { undercurl = true, sp = c.nord12 },
        ...
        LspDiagnosticsSignWarning            = { fg = c.nord12 },
        LspDiagnosticsFloatingWarning        = { fg = c.nord12 },
        LspDiagnosticsVirtualTextWarning     = { fg = c.nord12 },
